...
"""}}
    ...
    def candidate(self):
        return {"schemaVersion": 1, "manifest": {"id": "sample", "version": "1.2.3", "sha256": "b" * 64}, "provenance": {
    ...
    def test_parses_trusted_handoff_and_binds_provenance(self):
        ...
        manifest, provenance = community_distribution.prepare(self.candidate(), handoff)
